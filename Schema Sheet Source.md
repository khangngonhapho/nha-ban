...
## Cấu trúc 46 cột của sheet Source
...
| 41 | `Đăng BDS` | checkbox | ✅ | Checkbox kích hoạt Bot đăng tin tự động (Cột AO). |
| 42 | `anh_11` | URL | ⬜ | **[NEW]** Ảnh bổ sung thứ 11 (Cột AP). |
| 43 | `anh_12` | URL | ⬜ | **[NEW]** Ảnh bổ sung thứ 12 (Cột AQ). |
| 44 | `anh_13` | URL | ⬜ | **[NEW]** Ảnh bổ sung thứ 13 (Cột AR). |
| 45 | `anh_14` | URL | ⬜ | **[NEW]** Ảnh bổ sung thứ 14 (Cột AS). |
| 46 | `anh_15` | URL | ⬜ | **[NEW]** Ảnh bổ sung thứ 15 (Cột AT). |
