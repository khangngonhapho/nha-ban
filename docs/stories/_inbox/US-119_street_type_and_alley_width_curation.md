...
## 📝 Task Checklist (TODO)
- [ ] **Khảo sát & Thiết kế:** Đăng ký và lập kế hoạch US-119
- [ ] **Google Sheets & Apps Script:** Bảo vệ trường do_rong_hem trên Source
- [ ] **Database & Backend:** Cập nhật API save của SQLite local
- [ ] **Vercel Detail page (Admin Curation):** Tách biệt hiển thị read-only, thêm trường Độ rộng hẻm custom và sửa luồng lưu
- [ ] **AI Payload & Core:** Sửa payload AI và logic fallback
- [ ] **Kiểm thử & Nghiệm thu:** Kiểm tra luồng lưu và hiển thị trên local
